...
function fixFile(path) {
    ...
    // RoadToMax specifics
    content = content.replace(/border-emerald-400 bg-emerald-50/g, 'border-emerald-400 bg-emerald-50 dark:bg-emerald-900/30 dark:border-emerald-500/50');
    content = content.replace(/border-blue-300 bg-blue-50(?!\/| )/g, 'border-blue-300 bg-blue-50 dark:bg-blue-900/30 dark:border-blue-500/50');
    content = content.replace(/border-blue-300 bg-blue-50\/50/g, 'border-blue-300 bg-blue-50/50 dark:bg-blue-900/30 dark:border-blue-500/50');
    content = content.replace(/bg-slate-800 text-white/g, 'bg-slate-800 dark:bg-slate-700 text-white');
    content = content.replace(/border-white/g, 'border-white dark:border-slate-700');

    // CRCardsPage specific text-blue-600
...
fixFile('src/components/RoadToMaxCard.tsx');
fixFile('src/components/CardCollectionSummary.tsx');
fixFile('src/components/MasteryBadge.tsx');
