...
class _$UserProfileEntityImpl extends _UserProfileEntity {
  ...
  @override
  String toString() {
    return 'UserProfileEntity(id: $id, userId: $userId, name: $name, type: $type, icon: $icon, color: $color, active: $active, createdAt: $createdAt, updatedAt: $updatedAt, sortOrder: $sortOrder)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, userId, name, type, icon,
      color, active, createdAt, updatedAt, sortOrder);
...
abstract class _UserProfileEntity extends UserProfileEntity {
  const factory _UserProfileEntity(
      ...
      required final int sortOrder}) = _$UserProfileEntityImpl;
