...
class _$TransactionEntityImpl extends _TransactionEntity {
  ...
  @override
  String toString() {
    return 'TransactionEntity(id: $id, profileId: $profileId, categoryId: $categoryId, type: $type, amount: $amount, description: $description, date: $date, createdAt: $createdAt, updatedAt: $updatedAt, tagIds: $tagIds)';
  }
...
abstract class _TransactionEntity extends TransactionEntity {
  const factory _TransactionEntity(
      ...
      final List<String>? tagIds}) = _$TransactionEntityImpl;
