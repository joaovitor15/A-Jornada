...
class _$CategoryModelImpl extends _CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, profileId: $profileId, name: $name, parentId: $parentId, icon: $icon, color: $color, createdAt: $createdAt, updatedAt: $updatedAt, sortOrder: $sortOrder)';
  }
