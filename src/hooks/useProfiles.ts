...
export function useProfiles() {
  ...
  async function createProfile(name: string, tipo: 'pessoal' | 'empresa', cor: string, icone: string) {
    setLoading(true);
    const currentUserId = await getUserId();
  ...
  async function updateProfile(id: string, name: string, tipo: 'pessoal' | 'empresa', cor: string, icone: string) {
    setLoading(true);
    const { error } = await supabase
      .from('profiles')
      .update({ 
