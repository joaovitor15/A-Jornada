                ...
                <div key={conta.id} className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border border-transparent hover:border-slate-100 dark:hover:border-slate-700/50 group">
                  ...
                  <div className="flex items-center gap-3 pl-2 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-full flex items-center justify-center bg-slate-100/0 hover:bg-green-100 dark:hover:bg-green-900/30 text-slate-400 hover:text-green-600 dark:hover:text-green-400 transition-all opacity-0 group-hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-green-500"
            ...
            >
              ...
              <div className="flex items-center justify-end gap-2.5 pt-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 rounded-xl text-xs font-black text-white hover:scale-102 transition-all active:scale-95 disabled:opacity-75 flex items-center justify-center gap-2"
                >
