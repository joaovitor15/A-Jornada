        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
              ...
              {tipo !== 'investimento' && (
                <div>
                  ...
                  <input 
                    ...
                    className="w-full border-[1.5px] border-[#E2E8F0] dark:border-[#1E293B] rounded-[14px] p-[10px_14px] text-[14px] font-[500] bg-[#F8FAFC] dark:bg-[#0B0F19] outline-none transition-all focus:border-[#2563EB] focus:shadow-[0_0_0_3px_rgba(37,99,235,0.08)]" 
              ...
              <div className={`grid ${tipo === 'investimento' ? 'grid-cols-1' : 'grid-cols-2'} gap-[12px] items-start`}>
                    ...
                    {tagSelecionada ? (
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-[#F8FAFC] dark:bg-[#0B0F19] border-[1.5px] border-[#E2E8F0] dark:border-[#1E293B] rounded-[12px] p-[10px_12px_10px_34px] text-[14px] font-[500] outline-none transition-all focus:border-[#2563EB] focus:shadow-[0_0_0_3px_rgba(37,99,235,0.08)]"
                        />
                      </div>
                    )}
                  </div>
                ...
                {tipo !== 'investimento' && (
                  <div>
                    ...
                    <select value={frequencia} onChange={e => setFrequencia(e.target.value as any)} className="w-full border-[1.5px] border-[#E2E8F0] dark:border-[#1E293B] rounded-[14px] p-[10px_14px] text-[14px] font-[500] bg-[#F8FAFC] dark:bg-[#0B0F19] text-[#0F172A] dark:text-white outline-none cursor-pointer appearance-none transition-all focus:border-[#2563EB] focus:shadow-[0_0_0_3px_rgba(37,99,235,0.08)]">
                  ...
                  <div className="grid grid-cols-2 gap-[12px] items-end">
                    <div className="w-full">
                      ...
                      {!valorVariavel ? (
                        <input 
                          ...
                          className={`w-full text-center border-[1.5px] border-[#E2E8F0] dark:border-[#1E293B] rounded-[14px] p-[10px_14px] text-[15px] font-[800] bg-[#F8FAFC] dark:bg-[#0B0F19] outline-none transition-all focus:border-[#2563EB] disabled:bg-[#F1F5F9] disabled:dark:bg-[#1E293B] disabled:text-[#94A3B8] disabled:border-[#E2E8F0] disabled:dark:border-[#1E293B] ${tipo === 'receita' ? 'text-[#16A34A]' : 'text-[#EF4444]'}`} 
                        />
                      ) : (
                    ...
                    <div className="pb-3 flex flex-col items-start justify-end space-y-[10px]">
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <div className={`w-5 h-5 rounded-[6px] border-[1.5px] flex items-center justify-center transition-colors ${valorVariavel ? 'bg-[#2563EB] border-[#2563EB]' : 'bg-[#F8FAFC] dark:bg-[#0B0F19] border-[#CBD5E1] group-hover:border-[#94A3B8]'}`}>
                      ...
                      {frequencia === 'diaria' && (
                        <label className="flex items-center gap-2 cursor-pointer group">
                          <div className={`w-5 h-5 rounded-[6px] border-[1.5px] flex items-center justify-center transition-colors ${diaVencimento === 1 ? 'bg-[#2563EB] border-[#2563EB]' : 'bg-[#F8FAFC] dark:bg-[#0B0F19] border-[#CBD5E1] group-hover:border-[#94A3B8]'}`}>
                      ...
                      {frequencia !== 'diaria' && (
                        <label className="flex items-center gap-2 cursor-pointer group">
                          <div className={`w-5 h-5 rounded-[6px] border-[1.5px] flex items-center justify-center transition-colors ${diaVencimento === null ? 'bg-[#2563EB] border-[#2563EB]' : 'bg-[#F8FAFC] dark:bg-[#0B0F19] border-[#CBD5E1] group-hover:border-[#94A3B8]'}`}>
                  ...
                  {frequencia === 'mensal' && diaVencimento !== null && (
                    <div className="flex gap-[12px]">
                      <div className="flex-1">
                        ...
                        <input type="number" min="1" max="31" value={diaVencimento} onChange={e => setDiaVencimento(e.target.value ? Number(e.target.value) : '')} className="w-full border-[1.5px] border-[#E2E8F0] dark:border-[#1E293B] rounded-[14px] p-[10px_14px] text-[14px] font-[500] bg-[#F8FAFC] dark:bg-[#0B0F19] outline-none transition-all focus:border-[#2563EB]" placeholder="1 a 31" />
                      </div>
                      {isBusiness && (
                        <div className="flex-1">
                          <label className="block text-[12px] font-[700] text-[#64748B] dark:text-[#94A3B8] uppercase tracking-wider mb-[6px]">Dia de Tirar</label>
                          <input type="number" min="1" max="31" value={diaEmissao} onChange={e => setDiaEmissao(e.target.value ? Number(e.target.value) : '')} className="w-full border-[1.5px] border-[#E2E8F0] dark:border-[#1E293B] rounded-[14px] p-[10px_14px] text-[14px] font-[500] bg-[#F8FAFC] dark:bg-[#0B0F19] outline-none transition-all focus:border-[#2563EB]" placeholder="Opcional" />
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  {frequencia === 'anual' && (
                      <div className={`grid ${diaVencimento !== null ? 'grid-cols-2 gap-[12px]' : 'grid-cols-1'} items-start`}>
                          ...
                          <div>
                            ...
                            <select value={mesVencimento} onChange={e => setMesVencimento(e.target.value ? Number(e.target.value) : '')} className="w-full border-[1.5px] border-[#E2E8F0] dark:border-[#1E293B] rounded-[14px] p-[10px_14px] text-[14px] font-[500] bg-[#F8FAFC] dark:bg-[#0B0F19] text-[#0F172A] dark:text-white outline-none cursor-pointer appearance-none transition-all focus:border-[#2563EB]">
                  ...
                  {tipo === 'despesa' && cards.length > 0 && (
                    <div>
                      ...
                      <select 
                        ...
                        className="w-full border-[1.5px] border-[#E2E8F0] dark:border-[#1E293B] rounded-[14px] p-[10px_14px] text-[14px] font-[500] bg-[#F8FAFC] dark:bg-[#0B0F19] text-[#0F172A] dark:text-white outline-none cursor-pointer appearance-none focus:border-[#2563EB]"
                      >
                  ...
                  {(formaPagamento === 'cartao_credito' || cardId) && (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <div className="relative flex-1">
                          ...
                          <input 
                            ...
                            className="w-full bg-[#F8FAFC] dark:bg-[#0B0F19] border-[1.5px] border-[#E2E8F0] dark:border-[#1E293B] rounded-[14px] p-[10px_14px_10px_36px] text-[14px] font-[500] outline-none transition-all focus:border-[#2563EB]"
                            placeholder="Ex: 12"
                          />
                        </div>
                      ...
                      {(numParcelas > 1 && !valorVariavel) && (
                        <div className="mt-[12px] p-[10px] bg-slate-100/50 dark:bg-slate-800/50 border border-[#E2E8F0] dark:border-[#1E293B] rounded-[10px] flex justify-between items-center">
            ...
            <div className="mt-[24px] flex gap-[12px]">
              <button onClick={onClose} className="btn-cancelar flex-1">Cancelar</button>
              <button disabled={saving} onClick={handleSave} className="btn-salvar flex-1">
