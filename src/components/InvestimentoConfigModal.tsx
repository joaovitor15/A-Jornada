  ...
  return (
    <AnimatePresence>
      ...
      <motion.div 
        ...
        className="fixed inset-0 m-auto md:w-[420px] h-fit bg-white dark:bg-slate-800 shadow-xl rounded-2xl z-50 overflow-hidden flex flex-col max-h-[90vh]"
      >
        ...
        <div className="p-5 overflow-y-auto overflow-x-hidden relative flex-1 space-y-5">
          <div>
             ...
             <input
                ...
                placeholder="R$ 0,00"
                className="w-full bg-[#F8FAFC] dark:bg-[#0F172A] border-[1.5px] border-[#E2E8F0] dark:border-[#334155] rounded-[12px] p-[10px_12px] text-[16px] font-[600] text-amber-500 dark:text-amber-400 outline-none transition-all focus:border-amber-500 focus:shadow-[0_0_0_3px_rgba(245,158,11,0.08)]"
             />
          ...
          <div className="flex flex-col sm:flex-row gap-4">
                ...
                {tagSelecionada ? (
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Buscar ativo/tag..."
                      className="w-full bg-[#F8FAFC] dark:bg-[#0F172A] border-[1.5px] border-[#E2E8F0] dark:border-[#334155] rounded-[12px] p-[10px_12px_10px_34px] text-[14px] font-[500] outline-none transition-all focus:border-amber-500 focus:shadow-[0_0_0_3px_rgba(245,158,11,0.08)]"
                    />
                  </div>
                )}
              </div>
            ...
            <div className="flex-1">
              ...
              <select 
                ...
                className="w-full bg-[#F8FAFC] dark:bg-[#0F172A] border-[1.5px] border-[#E2E8F0] dark:border-[#334155] rounded-[12px] p-[10px_12px] text-[14px] font-[500] outline-none transition-all focus:border-amber-500 focus:shadow-[0_0_0_3px_rgba(245,158,11,0.08)]"
              >
        ...
        <div className="p-5 border-t border-slate-100 dark:border-slate-700/50 flex flex-col gap-3">
          <button 
             onClick={handleSave} 
             disabled={saving}
             className="w-full bg-slate-800 dark:bg-white text-white dark:text-slate-900 font-[700] text-[14px] rounded-[14px] py-[12px] hover:bg-slate-700 dark:hover:bg-slate-200 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
          >
