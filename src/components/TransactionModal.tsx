      ...
      {isOpen && (
        ...
        >
          <motion.div 
            ...
            className="bg-gradient-to-br from-[#F8FAFC] to-[#F1F5F9] dark:from-[#0B0F19] dark:to-[#0F172A] border border-[#E2E8F0] dark:border-[#1E293B] rounded-[24px] p-[20px] w-full max-w-[420px] shadow-2xl max-h-[80vh] overflow-y-auto"
          >
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 rounded-[100px] py-[8px] px-[16px] text-[14px] font-[700] transition-all duration-200 ${
              tipo === "receita"
                ...
                : "bg-[#F8FAFC] dark:bg-[#0F172A] text-[#64748B] dark:text-[#94A3B8] border-[1.5px] border-[#E2E8F0] dark:border-[#334155] hover:bg-[#F1F5F9] dark:hover:bg-[#475569]"
            }`}
          >
            <TrendingUp size={15} />
            Receita
        ...
        <div className="space-y-[14px]">
          ...
          <div className="relative" ref={containerTagRef}>
            ...
            {mostrarDropdownTag && (
              <div className="absolute top-[calc(100%+4px)] left-0 right-0 bg-gradient-to-br from-[#F8FAFC] to-[#F1F5F9] dark:from-[#0B0F19] dark:to-[#0F172A] border border-[#E2E8F0] dark:border-[#334155] rounded-[16px] shadow-[0_12px_32px_rgba(0,0,0,0.12)] max-h-[220px] overflow-y-auto z-[60] p-[6px] space-y-[2px]">
                ...
                <div className="animate-in fade-in slide-in-from-top-1 duration-200 mt-3 flex items-center gap-3 bg-[#F8FAFC] dark:bg-[#0F172A] p-3 rounded-xl border border-[#E2E8F0] dark:border-[#334155]">
                  <div className="w-[80px]">
                    ...
                    <input
                      ...
                      className="w-full bg-[#F8FAFC] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#334155] rounded-lg px-3 py-1.5 text-xs font-bold text-[#0F172A] dark:text-white outline-none focus:border-[#2563EB] transition-all"
                    />
                  </div>
