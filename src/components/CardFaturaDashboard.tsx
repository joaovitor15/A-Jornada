...
export function CardFaturaDashboard({ activeProfileId, setActivePage }: CardFaturaDashboardProps) {
  ...
  if (viewingOffset < 0) {
      if (valorFaturaAtualView <= 0 && despesasPassado > 0) {
          statusContextual = 'PAGA'; // Mês fechado e pago
      } else if (valorFaturaAtualView <= 0 && despesasPassado === 0) {
  ...
  const temFaturaAnteriorPendente = unpaidPassado > 0;
      ...
      <div className="bg-white dark:bg-[#1E293B] rounded-[24px] border border-[#E2E8F0] dark:border-[#334155] shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-2 mt-auto">
            ...
            {statusContextual === 'ABERTA' && unpaidFuturo > 0 && (
              <button 
                onClick={() => {
          ...
          <div className="bg-white dark:bg-[#1E293B] rounded-[32px] w-full max-w-md shadow-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-6">
               ...
               <button 
                 ...
                 className="w-full py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-xl font-bold transition-all shadow-md mt-2 cursor-pointer"
               >
          ...
          <div className="bg-white dark:bg-[#1E293B] rounded-[32px] w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-700/50 sticky bottom-0">
               ...
               <button 
                 ...
                 className="w-full py-3 bg-amber-500 hover:bg-amber-600 text-white rounded-xl font-bold transition-all shadow-md mt-4 cursor-pointer"
               >
                 Confirmar Antecipação
               </button>
            </div>
          ...
          <div className="bg-white dark:bg-[#1E293B] rounded-[24px] w-full max-w-sm shadow-2xl overflow-hidden p-6 text-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 px-4 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl font-bold text-sm transition-colors flex items-center justify-center gap-2"
              >
                  ...
                  return (
                    <>
                      ...
                      <div className="px-6 pt-6 shrink-0">
                         ...
                         {faturaOffsetVisualizar < 0 && valorFaturaItem > 0 && (
                            <button 
                              onClick={() => {
