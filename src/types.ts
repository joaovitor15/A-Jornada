...
export type Page = 'dashboard' | 'transactions' | 'profiles' | 'reports' | 'settings' | 'categories' | 'recorrentes' | 'relatorios' | 'cartoes' | 'investimentos' | 'investimentos_ativos' | 'investimentos_cofres' | 'game' | 'cr_profile' | 'cr_cards' | 'cr_badges' | 'bs_profile' | 'bs_brawlers';
